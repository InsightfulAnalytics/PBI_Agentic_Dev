...
- **No CALCULATE DAX skill (fork addition):** Method distilled, with attribution, from *DAX For Humans* by Gregory Deckler (ISBN 9798290175508); not covered by this repo's GPL-3.0 grant — see the notice in `plugins/semantic-models/skills/dax-no-calculate/`.
